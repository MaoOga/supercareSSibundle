<?php
// Audit Log with Proper Session Management
    ...
    <script>
      ...
      async function loadAuditStats() {
        ...
        try {
          ...
          const response = await fetch(`get_audit_stats.php?days=${days}`);
      ...
      async function loadAuditLogs() {
        ...
        try {
          ...
          const response = await fetch(`get_audit_logs.php?${params}`);
      ...
      async function showLogDetails(auditId) {
        try {
          const response = await fetch(
            `get_audit_logs.php?audit_id=${auditId}`
          );
     ...
     >
          ...
          <a href="audit_log.html" class="nav-item is-active">
            <i class="fas fa-chart-line"></i>
            <span>Audit</span>
          </a>
          <button id="mobileLogoutBtn" class="nav-item">
            <i class="fas fa-sign-out-alt"></i>
            <span>Logout</span>
          </button>
        </div>
