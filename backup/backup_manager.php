...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="sm:hidden flex flex-col gap-2 mb-6">
            ...
            <a href="../admin/audit_log.php" class="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600 transition-colors text-center">
    ...
    >
        <div class="grid grid-cols-4 items-stretch">
            <a href="../admin/admin.php" class="nav-item">
                <i class="fas fa-shield-halved"></i>
                <span>Admin</span>
            </a>
            ...
            <a href="../admin/audit_log.php" class="nav-item">
                <i class="fas fa-chart-line"></i>
                <span>Audit</span>
            </a>
