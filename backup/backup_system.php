...
try {
    ...
    // If audit logger fails, we'll continue without it
    $auditLogger = null;
    logMessage("Warning: Audit logger initialization failed: " . $e->getMessage(), true);
}
    ...
    <body class="bg-gray-100 min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
            <div class="text-center">
                ...
                <a href="../admin/admin.php" class="inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors">
