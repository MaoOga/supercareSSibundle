...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($email) && !empty($password) && !empty($name)) {
        ...
        try {
            ...
            echo "<p><a href='super_admin_login.html' style='color: #007bff; font-weight: bold;'>→ Test Login Now</a></p>";
            echo "<p><a href='test_new_super_admin_system.php' style='color: #007bff;'>→ Run Full System Test</a></p>";
            echo "</div>";
...
echo "<p><a href='test_new_super_admin_system.php' style='color: #007bff;'>→ Run System Test</a></p>";
