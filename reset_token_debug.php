...
if (isset($_GET['test_email'])) {
    ...
    try {
        ...
        if ($nurse) {
            ...
            echo "<p><strong>Reset Link:</strong> <a href='reset_password.html?token=" . $resetToken . "' target='_blank'>Click here to test</a></p>";
            echo "</div>";
        } else {
            echo "<div style='background: #f8d7da; border: 1px solid #f5c6cb; padding: 15px; margin: 10px 0; border-radius: 5px;'>";
...
echo "<p><a href='forgot_password.html' style='background: #1aaf51; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Request New Reset Link</a></p>";
?>
