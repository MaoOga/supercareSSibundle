...
if (!$adminSession->validateSession()) {
    ...
    echo "<p><a href='admin_login_new.html'>Go to admin login</a></p>";
    exit();
}
...
echo "<li><a href='admin.php' target='_blank'>Test admin.php</a></li>";
echo "</ul>";
...
echo "<li><a href='audit_log.php' target='_blank'>Test audit_log.php</a></li>";
echo "</ul>";
...
echo "<li><a href='admin_patient_records.php' target='_blank'>Test admin_patient_records.php</a></li>";
echo "</ul>";
