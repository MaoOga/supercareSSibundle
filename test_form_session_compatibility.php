...
if ($logged_in && $session_valid) {
    ...
    echo "<p><a href='form.php' target='_blank'>Test form.php access</a></p>";
} else {
    echo "<p>❌ Form.php should redirect to login</p>";
    echo "<p><a href='form.php' target='_blank'>Test form.php redirect</a></p>";
}
...
echo "<p><a href='nurse_logout.php' target='_blank'>Test nurse logout</a></p>";
...
echo "<ul>";
echo "<li><a href='index.php'>index.php</a> (protected)</li>";
echo "<li><a href='search.php'>search.php</a> (protected)</li>";
echo "<li><a href='form.php'>form.php</a> (protected)</li>";
echo "<li><a href='login.html'>login.html</a> (public)</li>";
echo "</ul>";
