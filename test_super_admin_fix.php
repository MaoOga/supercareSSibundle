...
echo "<a href='secure_super_admin_login_simple.html' target='_blank'>Super Admin Login</a><br>";
echo "<a href='super_admin_dashboard_simple.html' target='_blank'>Super Admin Dashboard</a><br>";
echo "<a href='fix_admin_users_table.sql' target='_blank'>Database Fix Script</a><br>";
