...
echo "<a href='../admin/admin.php' target='_blank'>Access Admin Panel</a><br>";
...
echo "1. <a href='../admin/admin.php' target='_blank'>Try accessing the admin panel directly</a><br>";
echo "2. <a href='../admin/admin_login_new.html' target='_blank'>Try the login page</a><br>";
