...
echo "1. <a href='../admin/admin_login_new.html' target='_blank'>Login Page</a><br>";
echo "2. <a href='../admin/admin.php' target='_blank'>Admin Panel</a><br>";
echo "3. <a href='../admin/audit_log.php' target='_blank'>Audit Log</a><br>";
echo "4. <a href='../admin/admin_patient_records.php' target='_blank'>Patient Records</a><br>";
