...
echo "<a href='../super admin/generate_super_admin_password.php' style='background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-right: 10px;'>Generate Password Hash</a>";
echo "<a href='../auth/super_admin_login.html' style='background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-right: 10px;'>Test New Login</a>";
echo "<a href='../database/create_super_admin_table.sql' style='background: #ffc107; color: black; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>View Database Schema</a>";
echo "</div>";
