...
if ($logged_in && $session_valid) {
    ...
    echo "<ul>";
    echo "<li><a href='../pages/index.php' target='_blank'>Test index.php (should show nurse ID)</a></li>";
echo "<li><a href='../forms/search.php' target='_blank'>Test search.php (should show nurse ID)</a></li>";
    echo "</ul>";
    
    echo "<h3>Test Form Submission Flow:</h3>";
    echo "<p>1. <a href='../forms/form.php' target='_blank'>Go to form.php</a></p>";
